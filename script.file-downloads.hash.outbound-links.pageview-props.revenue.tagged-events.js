!function() {
    var a, o = window.location, l = window.document, u = l.currentScript, s = u.getAttribute("data-api") || new URL(u.src).origin + "/api/event", c = u.getAttribute("data-domain");
    function p(e, t, n) {
    ...
    function y() {
        "visible" === l.visibilityState && l.hasFocus() && null === h ? h = Date.now() : "hidden" !== l.visibilityState && l.hasFocus() || (m = i(),
        h = null,
        b())
    }
    function L(e, t) {
        ...
        t && t.revenue && (i.$ = t.revenue),
        u.getAttributeNames().filter(function(e) {
        ...
        m = 0,
        h = Date.now(),
        w || (l.addEventListener("visibilitychange", y),
    ...
    function _(e) {
        if ("auxclick" !== e.type || e.button === H) {
            var t, n, i = (e => {
                for (; e && (void 0 === e.tagName || !S(e) || !e.href); )
                    e = e.parentNode;
                return e
            }
            ...
            if (!function e(t, n) {
                ...
                return (t = i) && t.href && t.host && t.host !== o.host ? A(e, i, {
    ...
    function A(e, t, n) {
        ...
        ( (e, t) => !e.defaultPrevented && (t = !t.target || t.target.match(/^_(self|parent|top)$/i),
    ...
    function $(e) {
        ...
        if (n)
            for (var i = 0; i < n.length; i++) {
                var r, a, o = n.item(i), l = o.match(/plausible-event-(.+)(=|--)(.+)/), l = (l && (r = l[1],
                a = l[3].replace(/\+/g, " "),
                "name" == r.toLowerCase() ? t.name = a : t.props[r] = a),
                o.match(/plausible-revenue-(.+)(=|--)(.+)/));
                l && (r = l[1],
                a = l[3],
                t.revenue[r] = a)
            }
    ...
    function I(e) {
        if ("auxclick" !== e.type || e.button === H) {
            for (var t, n, i, r, a = e.target, o = 0; o <= O && a; o++) {
                if ((i = a) && i.tagName && "form" === i.tagName.toLowerCase())
                    return;
                S(a) && (t = a),
                z(a) && (n = a),
                a = a.parentNode
